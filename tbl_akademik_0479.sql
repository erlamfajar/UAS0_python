...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2022 at 08:16 PM
...
--
-- Table structure for table `tbl_akademik_0479`
--

CREATE TABLE `tbl_akademik_0479` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_akademik_0479`
--

INSERT INTO `tbl_akademik_0479` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
